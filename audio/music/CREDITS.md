...
- `game_impact_prelude.ogg` — "Impact Prelude"
- `game_machinations.ogg` — "Machinations"
- `game_mechanolith.ogg` — "Mechanolith"
- `game_rocket.ogg` — "Rocket"
- `game_stormfront.ogg` — "Stormfront"
- `game_unrelenting.ogg` — "Unrelenting"
