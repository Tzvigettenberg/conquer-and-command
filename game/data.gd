...
const WEAPONS := {
	...
	"md_missile": {"dmg": 40.0, "type": "INFANTRY_MISSILE", "range": 35.0, "cd": 1.0, "speed": 120.0, "radius": 1.0, "aa": true, "ag": true, "style": "missile"},
	...
	"humvee_tow": {"dmg": 40.0, "type": "INFANTRY_MISSILE", "range": 35.0, "cd": 2.5, "speed": 120.0, "radius": 1.0, "aa": true, "ag": true, "style": "missile"},
	"crusader_gun": {"dmg": 60.0, "type": "ARMOR_PIERCING", "range": 30.0, "cd": 2.0, "speed": 80.0, "radius": 1.0, "aa": false, "ag": true, "style": "shell"},
	"paladin_gun": {"dmg": 60.0, "type": "ARMOR_PIERCING", "range": 30.0, "cd": 2.0, "speed": 60.0, "radius": 1.0, "aa": false, "ag": true, "style": "shell"},
	...
	"comanche_rockets": {"dmg": 30.0, "type": "EXPLOSION", "range": 40.0, "cd": 0.2, "clip": 20, "reload": 30.0, "speed": 100.0, "radius": 1.0, "dmg2": 10.0, "radius2": 8.0, "aa": false, "ag": true, "style": "missile", "upgrade": "rocket_pods"},
	"raptor_missile": {"dmg": 100.0, "type": "JET_MISSILES", "range": 64.0, "min_range": 8.0, "cd": 0.15, "clip": 4, "reload": -1.0, "speed": 200.0, "radius": 1.0, "aa": true, "ag": true, "style": "missile"},
...
const UNITS := {
	"dozer": {"name": "Construction Dozer", "cost": 1000, "time": 5.0, "hp": 250.0, "armor": "DozerArmor", "speed": 6.0, "turn": 90.0,
		"vision": 40.0, "radius": 1.6, "length": 6.0, "cat": "veh", "from": "command_center", "weapons": [], "builder": true, "crusher": true,
	...
	"ranger": {"name": "Ranger", "cost": 225, "time": 5.0, "hp": 180.0, "armor": "HumanArmor", "speed": 4.0, "turn": 500.0,
		"vision": 20.0, "radius": 0.5, "length": 1.8, "cat": "inf", "from": "barracks", "weapons": ["ranger_rifle"], "crushable": true,
	...
	"missile_defender": {"name": "Missile Defender", "cost": 300, "time": 5.0, "hp": 100.0, "armor": "HumanArmor", "speed": 4.0, "turn": 500.0,
		"vision": 30.0, "radius": 0.5, "length": 1.8, "cat": "inf", "from": "barracks", "weapons": ["md_missile"], "crushable": true,
	...
	"pathfinder": {"name": "Pathfinder", "cost": 600, "time": 10.0, "hp": 120.0, "armor": "HumanArmor", "speed": 6.0, "turn": 500.0,
		"vision": 40.0, "radius": 0.5, "length": 1.8, "cat": "inf", "from": "barracks", "weapons": ["pathfinder_rifle"], "crushable": true,
	...
	"burton": {"name": "Colonel Burton", "cost": 1500, "time": 20.0, "hp": 200.0, "armor": "HumanArmor", "speed": 6.0, "turn": 500.0,
		"vision": 30.0, "radius": 0.5, "length": 1.8, "cat": "inf", "from": "barracks", "weapons": ["burton_rifle"], "crushable": false,
	...
	"humvee": {"name": "Humvee", "cost": 700, "time": 10.0, "hp": 240.0, "armor": "HumveeArmor", "speed": 12.0, "turn": 180.0,
		"vision": 30.0, "radius": 1.4, "length": 5.0, "cat": "veh", "from": "war_factory", "weapons": ["humvee_gun", "humvee_tow"],
		"model": "Vehicles/SM_Veh_Light_Armored_Car_01.tscn", "wreck": "Vehicles/Destroyed/SM_Veh_Light_Armored_Car_01_Destroyed.tscn",
		"desc": "Fast anti-infantry scout. TOW missiles with upgrade."},
	"crusader": {"name": "Crusader Tank", "cost": 900, "time": 10.0, "hp": 480.0, "armor": "TankArmor", "speed": 6.0, "turn": 180.0,
		"vision": 30.0, "radius": 1.8, "length": 6.0, "cat": "veh", "from": "war_factory", "weapons": ["crusader_gun"], "crusher": true, "turret": true,
	...
	"paladin": {"name": "Paladin Tank", "cost": 1100, "time": 12.0, "hp": 500.0, "armor": "TankArmor", "speed": 6.0, "turn": 180.0,
		"vision": 30.0, "radius": 1.9, "length": 6.5, "cat": "veh", "from": "war_factory", "weapons": ["paladin_gun"], "crusher": true, "turret": true,
		"needs_power": "paladin",
	...
	"tomahawk": {"name": "Tomahawk Launcher", "cost": 1200, "time": 20.0, "hp": 180.0, "armor": "TankArmor", "speed": 6.0, "turn": 180.0,
		"vision": 36.0, "radius": 1.8, "length": 6.0, "cat": "veh", "from": "war_factory", "weapons": ["tomahawk"], "prereq": ["strategy_center"],
	...
	"ambulance": {"name": "Ambulance", "cost": 600, "time": 10.0, "hp": 240.0, "armor": "HumveeArmor", "speed": 12.0, "turn": 180.0,
		"vision": 20.0, "radius": 1.4, "length": 5.0, "cat": "veh", "from": "war_factory", "weapons": [], "heal": {"cat": "inf", "radius": 12.0, "rate": 10.0},
	...
	"avenger": {"name": "Avenger", "cost": 2000, "time": 10.0, "hp": 300.0, "armor": "AvengerArmor", "speed": 6.0, "turn": 180.0,
		"vision": 30.0, "radius": 1.6, "length": 5.5, "cat": "veh", "from": "war_factory", "weapons": ["avenger_laser"], "prereq": ["strategy_center"], "turret": true,
	...
	"chinook": {"name": "Chinook", "cost": 1200, "time": 10.0, "hp": 300.0, "armor": "ChinookArmor", "speed": 30.0, "turn": 180.0,
		"vision": 60.0, "radius": 3.0, "length": 12.0, "cat": "air", "alt": 14.0, "from": "supply_center", "weapons": [], "gatherer": 8,
	...
	"comanche": {"name": "Comanche", "cost": 1500, "time": 20.0, "hp": 220.0, "armor": "ComancheArmor", "speed": 24.0, "turn": 180.0,
		"vision": 40.0, "radius": 2.5, "length": 9.0, "cat": "air", "alt": 16.0, "from": "airfield", "weapons": ["comanche_cannon", "comanche_rockets"],
	...
	"raptor": {"name": "Raptor", "cost": 1400, "time": 20.0, "hp": 160.0, "armor": "AirplaneArmor", "speed": 35.0, "turn": 120.0,
		"vision": 40.0, "radius": 3.0, "length": 12.0, "cat": "air", "alt": 20.0, "jet": true, "from": "airfield", "weapons": ["raptor_missile"],
	...
	"stealth_fighter": {"name": "Stealth Fighter", "cost": 1600, "time": 25.0, "hp": 120.0, "armor": "AirplaneArmor", "speed": 35.0, "turn": 180.0,
		"vision": 36.0, "radius": 3.0, "length": 12.0, "cat": "air", "alt": 20.0, "jet": true, "from": "airfield", "weapons": ["stealth_missile"],
	...
	"aurora": {"name": "Aurora Bomber", "cost": 2500, "time": 30.0, "hp": 80.0, "armor": "AirplaneArmor", "speed": 36.0, "turn": 180.0,
		"vision": 36.0, "radius": 3.0, "length": 13.0, "cat": "air", "alt": 22.0, "jet": true, "from": "airfield", "weapons": ["aurora_bomb"], "prereq": ["strategy_center"],
...
const BUILDINGS := {
	"command_center": {"name": "Command Center", "cost": 2000, "time": 45.0, "hp": 5000.0, "armor": "StructureArmorTough", "fp": Vector2i(6, 7),
		"power": 0, "vision": 60.0, "produces": ["dozer"], "model": "Buildings/SM_Bld_Hall_01.tscn", "height": 12.0,
	...
	"firebase": {"name": "Firebase", "cost": 1000, "time": 25.0, "hp": 1000.0, "armor": "FireBaseArmor", "fp": Vector2i(3, 3),
		"power": 0, "vision": 40.0, "prereq": ["power_plant"], "weapons": ["firebase_gun"], "turret": true,
		"model": "Buildings/SM_Bld_Tent_Sandbags_01.tscn", "height": 3.5, "desc": "155mm artillery emplacement."},
