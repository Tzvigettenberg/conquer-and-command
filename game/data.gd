...
const WEAPONS := {
	...
	"humvee_gun": {"dmg": 10.0, "type": "COMANCHE_VULCAN", "range": 30.0, "cd": 0.2, "speed": 0.0, "aa": false, "ag": true, "style": "bullet", "also": true},
	"humvee_tow": {"dmg": 40.0, "type": "INFANTRY_MISSILE", "range": 35.0, "cd": 2.5, "speed": 120.0, "radius": 1.5, "dmg2": 12.0, "radius2": 4.0, "aa": true, "ag": true, "style": "missile", "upgrade": "tow", "also": true},
	...
	"buggy_rockets": {"dmg": 25.0, "type": "EXPLOSION", "range": 60.0, "min_range": 10.0, "cd": 0.15, "clip": 6, "reload": 8.0, "speed": 90.0, "radius": 1.2, "dmg2": 8.0, "radius2": 4.0, "aa": false, "ag": true, "style": "missile"},
	...
	"tunnel_gun": {"dmg": 12.0, "type": "COMANCHE_VULCAN", "range": 34.0, "cd": 0.15, "speed": 0.0, "aa": false, "ag": true, "style": "bullet"},
	"mob_pistols": {"dmg": 9.0, "type": "SMALL_ARMS", "range": 22.0, "cd": 0.14, "speed": 0.0, "aa": false, "ag": true, "style": "bullet", "also": true, "until_upgrade": "arm_the_mob"},
	"mob_ak": {"dmg": 20.0, "type": "SMALL_ARMS", "range": 26.0, "cd": 0.1, "speed": 0.0, "aa": false, "ag": true, "style": "bullet", "also": true, "upgrade": "arm_the_mob"},
	"mob_molotov": {"dmg": 45.0, "type": "FLAME", "range": 20.0, "cd": 2.5, "speed": 22.0, "radius": 1.6, "dmg2": 15.0, "radius2": 3.0, "aa": false, "ag": true, "style": "shell", "also": true},
...
const UNITS := {
	...
	"worker": {"name": "Worker", "faction": "gla", "cost": 200, "time": 5.0, "hp": 100.0, "armor": "HumanArmor", "speed": 4.2, "turn": 500.0,
		"vision": 24.0, "radius": 0.4, "length": 1.65, "cat": "inf", "from": "gla_cc", "weapons": [], "builder": true, "gatherer": 1, "load_t": 1.0, "unload_t": 0.6, "crushable": true, "voice": "worker",
		"desc": "Builds and repairs structures, and carries supplies ($75 per trip)."},
	"rebel": {"name": "Rebel", "faction": "gla", "cost": 150, "time": 5.0, "hp": 120.0, "armor": "HumanArmor", "speed": 4.2, "turn": 500.0,
		...
		"desc": "Cheap anti-infantry. Can capture structures (upgrade); hides when still with Camouflage."},
	...
	"angry_mob": {"name": "Angry Mob", "faction": "gla", "cost": 800, "time": 15.0, "hp": 500.0, "armor": "HumanArmor", "speed": 3.8, "turn": 400.0,
		"vision": 22.0, "radius": 1.6, "length": 3.0, "cat": "inf", "from": "gla_barracks", "weapons": ["mob_pistols", "mob_ak", "mob_molotov"], "prereq": ["palace"], "mob": true, "no_board": true, "regen": 3.0, "voice": "angry_mob",
		"desc": "A crowd with pistols and molotovs. Grows back when hurt, can't enter buildings or vehicles. Arm the Mob hands out AK-47s."},
	...
	"rocket_buggy": {"name": "Rocket Buggy", "faction": "gla", "cost": 900, "time": 12.0, "hp": 150.0, "armor": "HumveeArmor", "speed": 13.0, "turn": 220.0,
		"vision": 40.0, "radius": 1.0, "length": 3.6, "cat": "veh", "from": "arms_dealer", "weapons": ["buggy_rockets"], "turret": true, "prereq": ["palace"], "snd": "humvee", "voice": "rocket_buggy",
		"desc": "Fast long-range rocket artillery. 6 rockets a volley (12 with Buggy Ammo). Needs the Palace."},
	...
	"scud_launcher": {"name": "SCUD Launcher", "faction": "gla", "cost": 1200, "time": 20.0, "hp": 180.0, "armor": "TankArmor", "speed": 6.0, "turn": 150.0,
		"vision": 36.0, "radius": 1.4, "length": 5.0, "cat": "veh", "from": "arms_dealer", "weapons": ["scud"], "prereq": ["palace"], "needs_power": "scud_launcher", "snd": "truck", "voice": "scud_launcher",
		"desc": "Long-range missile artillery. Warheads leave a toxin cloud. Needs the Palace and a General's promotion."},
	"bomb_truck": {"name": "Bomb Truck", "faction": "gla", "cost": 1200, "time": 15.0, "hp": 220.0, "armor": "HumveeArmor", "speed": 8.0, "turn": 180.0,
		"vision": 24.0, "radius": 1.2, "length": 4.2, "cat": "veh", "from": "arms_dealer", "weapons": ["bombtruck_bomb"], "suicide": true, "prereq": ["palace"], "snd": "truck", "voice": "gla_truck",
		"desc": "Drives into the target and detonates. Levels structures. Needs the Palace."},
	# ---- USA additions ----
...
const BUILDINGS := {
	...
	"gla_barracks": {"name": "Barracks", "faction": "gla", "role": "barracks", "cost": 500, "time": 10.0, "hp": 800.0, "armor": "StructureArmor", "fp": Vector2i(5, 5),
		"power": 0, "vision": 40.0, "produces": ["rebel", "rpg_trooper", "terrorist", "angry_mob", "jarmen_kell"], "upgrades": ["capture"],
	...
	"palace": {"name": "Palace", "faction": "gla", "role": "tech", "cost": 2500, "time": 45.0, "hp": 3000.0, "armor": "StructureArmorTough", "fp": Vector2i(6, 6),
		"power": 0, "vision": 60.0, "prereq": ["arms_dealer"], "upgrades": ["arm_the_mob", "camouflage", "toxin_shells", "anthrax_beta", "fortified_structure"], "cargo": 5, "fire_ports": true, "limit": 1, "height": 10.0,
		"desc": "Unlocks the Black Market, Angry Mob, Jarmen Kell, Rocket Buggy, Bomb Truck, SCUD Launcher and SCUD Storm. Garrison up to 5 infantry behind its walls."},
	"black_market": {"name": "Black Market", "faction": "gla", "role": "income", "cost": 2500, "time": 45.0, "hp": 1000.0, "armor": "StructureArmor", "fp": Vector2i(4, 4),
		"power": 0, "vision": 30.0, "prereq": ["palace"], "income": {"amount": 20, "every": 5.0}, "upgrades": ["ap_bullets", "ap_rockets", "buggy_ammo", "junk_repair", "worker_shoes"], "height": 6.0,
		"desc": "$20 every 5 s. Sells AP Bullets, AP Rockets, Buggy Ammo, Junk Repair and Worker Shoes. Needs the Palace."},
	"tunnel_network": {"name": "Tunnel Network", "faction": "gla", "role": "defense", "cost": 800, "time": 20.0, "hp": 1000.0, "armor": "BaseDefenseArmor", "fp": Vector2i(2, 2),
		"power": 0, "vision": 40.0, "prereq": ["gla_barracks"], "weapons": ["tunnel_gun"], "turret": true, "cargo": 10, "tunnel": true, "height": 3.0, "upgrades": ["camo_netting"],
		"desc": "Units that enter come out of any of your tunnels (10 shared slots). Machine gun on top; heals whoever is inside."},
	"stinger_site": {"name": "Stinger Site", "faction": "gla", "role": "defense", "cost": 900, "time": 20.0, "hp": 900.0, "armor": "BaseDefenseArmor", "fp": Vector2i(3, 3),
		"power": 0, "vision": 50.0, "prereq": ["gla_barracks"], "weapons": ["stinger"], "turret": true, "height": 2.5, "upgrades": ["camo_netting"], "desc": "Three Stinger soldiers behind sandbags (ground + air)."},
	"demo_trap": {"name": "Demo Trap", "faction": "gla", "role": "trap", "cost": 300, "time": 6.0, "hp": 100.0, "armor": "StructureArmor", "fp": Vector2i(1, 1),
		"power": 0, "vision": 12.0, "prereq": ["arms_dealer"], "trap": "demo_charge", "stealth": true, "height": 1.0, "desc": "Hidden explosive. Detonates when an enemy walks over it."},
...
const UPGRADES := {
	...
	"ap_bullets": {"name": "AP Bullets", "cost": 2000, "time": 45.0, "desc": "Small-arms damage +25% (Rebels, Technicals, Quad Cannons, mobs, Jarmen Kell)."},
	"ap_rockets": {"name": "AP Rockets", "cost": 2000, "time": 45.0, "desc": "Rocket damage +25% (RPG Troopers, Stingers, Buggies, SCUDs)."},
	"junk_repair": {"name": "Junk Repair", "cost": 2000, "time": 45.0, "desc": "Vehicles slowly repair themselves anywhere."},
	"anthrax_beta": {"name": "Anthrax Beta", "cost": 2500, "time": 30.0, "desc": "Toxin weapons +25% damage; the clouds turn blue."},
	"arm_the_mob": {"name": "Arm the Mob", "cost": 1000, "time": 30.0, "desc": "AK-47s for everyone: Angry Mobs hit twice as hard at longer range."},
	"camouflage": {"name": "Camouflage", "cost": 2000, "time": 45.0, "desc": "Rebels are stealthed while standing still."},
	"toxin_shells": {"name": "Toxin Shells", "cost": 1000, "time": 30.0, "desc": "Scorpion and Marauder shells leave a small toxin puddle."},
	"fortified_structure": {"name": "Fortified Structure", "cost": 1000, "time": 30.0, "desc": "Your structures take 25% less damage."},
	"buggy_ammo": {"name": "Buggy Ammo", "cost": 1200, "time": 30.0, "desc": "Rocket Buggies fire 12 rockets a volley instead of 6."},
	"worker_shoes": {"name": "Worker Shoes", "cost": 1000, "time": 10.0, "desc": "Workers walk 20% faster."},
	"camo_netting": {"name": "Camo Netting", "cost": 500, "time": 5.0, "desc": "This site is hidden until it fires.", "per_building": true},
	# ---- USA additions ----
...
const POWERS := {
	...
	"scud_launcher": {"name": "SCUD Launcher", "faction": "gla", "rank": 1, "kind": "unlock", "desc": "Unlocks the SCUD Launcher at the Arms Dealer (Palace needed too)."},
...
const FACTIONS := {
	...
	"gla": {"name": "GLA", "cc": "gla_cc", "builder": "worker", "desc": "Guerrillas: no power needed, tunnels, toxins, suicide bombers and the SCUD Storm.",
		...
		"inf": ["rebel", "rebel", "rpg_trooper", "terrorist", "angry_mob"], "veh": ["scorpion", "scorpion", "technical", "quad_cannon", "rocket_buggy", "toxin_tractor", "marauder", "scud_launcher"], "air": [],
		"upgrades": [["gla_barracks", "capture"], ["arms_dealer", "scorpion_rocket"], ["palace", "arm_the_mob"], ["palace", "toxin_shells"], ["black_market", "ap_bullets"], ["black_market", "ap_rockets"], ["palace", "anthrax_beta"], ["black_market", "junk_repair"], ["black_market", "buggy_ammo"], ["palace", "camouflage"], ["black_market", "worker_shoes"], ["palace", "fortified_structure"]],
		"powers": ["rebel_ambush", "marauder", "scud_launcher", "cash_bounty", "emergency_repair", "anthrax_bomb"], "strike_powers": ["rebel_ambush", "anthrax_bomb", "sneak_attack"]},
}
