...
var flight := "parked"         # jets: parked takeoff fly land
var air_spd := 0.0             # jets: current speed during takeoff / landing
var land_phase := 0
var guard_radius := 0.0        # > 0 while guarding an area
var plan := ""                 # strategy center: chosen battle plan
var plan_t := 0.0              # strategy center: seconds left until the plan is active
